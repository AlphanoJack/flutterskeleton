...
class FirebaseStorageRepository implements StorageRepository {
  ...
  Future<String> uploadImageFromApp(File appImageFile, ImageType type,
    ...
    try {
      ...
      talkerLog(
          'FirebaseStorageRepository(uploadImageFromApp)', '이미지 저장에 성공했습니다');
      final url = await storageRef.getDownloadURL();
      talkerLog(
          'FirebaseStorageRepository(uploadImageFromApp)', '이미지 URL: $url');

      return url;
    } catch (e) {
      talkerError('FirebaseStorageRepository(uploadImageFromApp)',
          '이미지 업로드에 실패하셨습니다.', e);
